...
function css() {
  ...
  var arrOfStyles = keys.map(function (key) {
    return "".concat(key, ": ").concat(styles[key], ";");
  });
  return arrOfStyles.join('');
}
...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      ...
      var tag = ((_this$options = this.options) === null || _this$options === void 0 ? void 0 : _this$options.tag) || 'h1',
          styles = ((_this$options2 = this.options) === null || _this$options2 === void 0 ? void 0 : _this$options2.styles) || '';
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      ...
      var _this$options3 = this.options,
          _this$options3$imageS = _this$options3.imageStyles,
          is = _this$options3$imageS === void 0 ? {} : _this$options3$imageS,
          _this$options3$alt = _this$options3.alt,
          alt = _this$options3$alt === void 0 ? '' : _this$options3$alt;
      return (0, _utils.row)("<img src=".concat(this.value, " alt=\"").concat(alt, "\" style=\"").concat((0, _utils.css)(is), "\" />"), (0, _utils.css)((_this$options4 = this.options) === null || _this$options4 === void 0 ? void 0 : _this$options4.styles));
    }
  }]);
...
var TextBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(TextBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)((0, _utils.col)("<p>".concat(this.value, "</p>")), (0, _utils.css)((_this$options5 = this.options) === null || _this$options5 === void 0 ? void 0 : _this$options5.styles));
    }
  }]);
...
var ColumnsBlock = /*#__PURE__*/function (_Block4) {
  ...
  _createClass(ColumnsBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)(html, (0, _utils.css)((_this$options6 = this.options) === null || _this$options6 === void 0 ? void 0 : _this$options6.styles));
    }
  }]);
  ...
  _createClass(Sidebar, [{
    ...
    value: function add(e) {
      ...
      switch (type) {
        ...
        case "columns":
          newBlock = new ColumnsBlock(value, {
            styles: styles
          });
          break;
...
exports.App = App;
},{"../classes/site":"classes/site.js","../classes/sidebar":"classes/sidebar.js"}],"model.js":[function(require,module,exports) {
"use strict";
...
}), new _blocks.TextBlock('some text'), new _blocks.ColumnsBlock(['111', '111', '111', '111', '111']), new _blocks.ImageBlock('https://html5css.ru/css/img_lights.jpg', {
  imageStyles: {
    width: '500px',
    height: 'auto'
  },
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4767" + '/');
